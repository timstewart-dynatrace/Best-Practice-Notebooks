...
| Conditional routing — by severity, team/service ownership (Ownership *Get owners* action, `primary_tags.team`, entity tags), the `event.severity` 1–5 scale and the SaaS 1.348 no-default change, time of day, escalation, multi-channel strategy | `-[WFLOW]-04-notification-routing.md` |
