...
1. [DQL Processor Commands](#dql-processor-commands)
2. [Dynatrace Pattern Language (DPL)](#dynatrace-pattern-language-dpl)
3. [Real-World Log Format Examples ⭐ NEW](#real-world-log-format-examples-new)
4. [Common Parsing Patterns](#common-parsing-patterns)
5. [Data Transformation Examples](#data-transformation-examples)
6. [Parsing Pattern Library ⭐ NEW](#parsing-pattern-library-new)
7. [ELK/Logstash Migration Patterns ⭐ NEW](#elklogstash-migration-patterns-new)
8. [Technology Bundle Parsers](#technology-bundle-parsers)
9. [Drop Processors](#drop-processors)
10. [Advanced Processing Patterns](#advanced-processing-patterns)
11. [Validating Your Processing](#validating-your-processing)
12. [DPL Architect Tool](#dpl-architect-tool)
13. [Complete Processing Pipeline Example](#complete-processing-pipeline-example)
...
<a id="real-world-log-format-examples-new"></a>
...
<a id="common-parsing-patterns"></a>
...
<a id="data-transformation-examples"></a>
...
<a id="parsing-pattern-library-new"></a>
...
<a id="advanced-processing-patterns"></a>
...
<a id="validating-your-processing"></a>
...
<a id="complete-processing-pipeline-example"></a>
