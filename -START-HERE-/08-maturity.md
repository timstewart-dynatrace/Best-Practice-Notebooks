...
![Maturity Loop](images/08-maturity-loop.svg)
...
- Domain gaps → [Domain Enablement Module](06-domain-enablement.md)
- Operations maturity → [Operationalize Module](07-operationalize.md)
- Foundation hygiene → [Foundation Module](05-foundation.md)
