...
| Gen2 → Gen3 access control | [MZ2POL](../MZ2POL%20-%20Management%20Zone%20to%20Policy%20Migration/) — full series | (overview only in [ONBRD](../ONBRD%20-%20Dynatrace%20Onboarding/), [IAM](../IAM%20-%20IAM%20Administration/)) | MZ2POL's access-control path applies only if migrating Gen2 permissions. If your MZs are used for filtering rather than permissions, read MZ2POL-05 alone (see the row above) rather than skipping the series. For the wider surface migration this sits inside, see [Doorway 4 — Classic → Gen3 Platform](04-gen2-to-gen3.md) |
...
| Data trust across masking, storage, access and audit | [FAQ](../FAQ%20-%20Frequently%20Asked%20Questions/) — entry 24 (the four axes, and where each is documented) | [ORGNZ](../ORGNZ%20-%20Organize%20Data:%20Buckets,%20Segments,%20Security/) — notebook 06; [IAM](../IAM%20-%20IAM%20Administration/) — notebooks 05, 07; [OPMIG](../OPMIG%20-%20OpenPipeline%20Migration/) — notebook 08 | FAQ-24 first for the map; then the series row it routes you to. Read it before an access design, not after |
