...
| Browser monitors: single-URL vs clickpaths, `dt.synthetic.browser.*` metrics, classic vs new browser experience (post-2026-01-26 tenants), validation and assertions; why Core Web Vitals (LCP/FCP/CLS) are RUM measurements and are *not* exposed as synthetic browser metric keys (go to WEBRUM instead) | `-[SYNTH]-02-browser-monitors.md` |
