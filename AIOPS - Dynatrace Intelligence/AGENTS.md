...
| Finding and quieting noisy detectors — which detectors fire most, measuring what a shadow-deployed detector would have done before enabling it | `-[AIOPS]-02-anomaly-detection.md` |
...
| AI Observability — monitoring *your own* GenAI application with Dynatrace, as distinct from using Dynatrace's AI | `-[AIOPS]-06-ai-integrations-and-agentic-workflows.md` |
