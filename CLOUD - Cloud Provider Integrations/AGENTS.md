...
| Connecting Azure: Azure Native Dynatrace Service, Entra ID app registration with a federated identity credential and Monitoring Reader, supported services, AKS, resource group mapping | `-[CLOUD]-05-azure-integration.md` |
